    ...
    >
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <label htmlFor="numbers" className="text-sm text-slate-600 dark:text-slate-400">
            Numbers
          </label>
        </div>
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="h-4 w-4 rounded text-indigo-600 focus:ring-indigo-500"
          />
          <label htmlFor="symbols" className="text-sm text-slate-600 dark:text-slate-400">
            Symbols
          </label>
        </div>
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="h-4 w-4 rounded text-indigo-600 focus:ring-indigo-500"
          />
          <label htmlFor="lookalikes" className="text-sm text-slate-600 dark:text-slate-400">
            Exclude Look-Alikes
          </label>
        </div>
      </div>
